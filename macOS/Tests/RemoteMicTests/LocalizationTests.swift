...
struct LocalizationTests {
    @Test func languageSelectionPersistsAndUpdatesTheLocaleImmediately() throws {
        ...
        #expect(localization.localizedWebsiteURL.absoluteString == "https://github.com/Bronc-X/voice-anything")
    ...
    @Test func publicLinksBelongToThisFork() {
        #expect(AppLinks.githubRepository.absoluteString == "https://github.com/Bronc-X/voice-anything")
        #expect(AppLinks.feedback.absoluteString == "https://github.com/Bronc-X/voice-anything/issues")
        #expect(AppLinks.testFlightPublicBeta == AppLinks.githubRepository)
    }
